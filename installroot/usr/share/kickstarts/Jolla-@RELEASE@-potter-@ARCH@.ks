# DisplayName: Jolla potter/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: potter
# DeviceVariant: potter
...
repo --name=adaptation-community-common-potter-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration potter
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/potter
